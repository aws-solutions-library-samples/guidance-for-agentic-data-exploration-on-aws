...
MSG_DELAY = int(os.environ.get('MSG_DELAY', '20'))
MAX_MESSAGES = int(os.environ.get('MAX_MESSAGES', '1'))
WAIT_TIME_SECONDS = int(os.environ.get('WAIT_TIME_SECONDS', '20'))  # Long polling
    ...
    while retry_count <= MAX_RETRIES:
        try:
            ...
            for message in messages:
                ...
                # INTENTIONAL: Add delay between processing messages
                time.sleep(MSG_DELAY)  # nosemgrep: arbitrary-sleep
